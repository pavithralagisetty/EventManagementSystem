...
if(isset($_POST['login']))
{
    ...
    $sql ="SELECT * FROM bitadmin WHERE UserName=:username and Password=:password";
    ...
    if($query->rowCount() > 0)
    {
        ...
        $aa= $_SESSION['odmsaid'];
        $sql="SELECT * from bitadmin  where ID=:aa";
        $query = $dbh -> prepare($sql);
        ...
        <div class="container-fluid page-body-wrapper full-page-wrapper">
            <div class="content-wrapper d-flex align-items-center auth p-0">
                <div class="row flex-grow">
                    ...
                    <h4>Welcome to BIT Occasion Planner.</h4>
                    </marquee>
                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                          <div class="carousel-inner">
                            <div class="carousel-item active">
                              <img class="d-block w-100" src="./assets/img/companyimages/bit.jpg" alt="First slide" >
                            </div>
                            <div class="carousel-item">
                              <img class="d-block w-100" src="./assets/img/companyimages/image1.jpg" alt="Second slide">
                            </div>
                            <div class="carousel-item">
                              <img class="d-block w-100" src="./assets/img/companyimages/image2.jpg" alt="Third slide">
                            </div>
                          </div>
