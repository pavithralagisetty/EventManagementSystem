...
if(isset($_POST['submit']))
{
    ...
    $sql="update bitcompany set companyaddress=:companyaddress,companyemail=:companyemail,regno=:regno,companyphone=:mobilenumber,companyname=:companyname ";
