...
if(!empty($_POST["fullname"])) {
  ...
  $sql ="SELECT UserName FROM bitadmin WHERE UserName=:fullname";
  ...
  if($query -> rowCount() > 0)
  {
    ...
    { 
        ...
        $sql="INSERT INTO  bitadmin(Staffid,AdminName,UserName,FirstName,LastName,Email,MobileNumber,Password) VALUES(:staffid,:dignity,:fname,:firstname,:lastname,:email,:mobile,:password)";
        $query = $dbh->prepare($sql);
