...
if(isset($_POST['submit']))
{
  ...
  $sql="insert into bitbooking(BookingID,ServiceID,Name,MobileNumber,Email,EventDate,EventStartingtime,EventEndingtime,VenueAddress,EventType,AdditionalInformation)values(:bookingid,:bid,:name,:mobnum,:email,:edate,:est,:eetime,:vaddress,:eventtype,:addinfo)";
...
<tbody>
               <?php
               $sql="SELECT * from bitbooking where Status is null";
               $query = $dbh -> prepare($sql);
               $query->execute();
